...
rememberLoginInfo()async{
  SharedPreferences spref=await SharedPreferences.getInstance();
  spref.setString('username', username.text);
  spref.setString('password', password.text);
}

getOldUsernameAndPassword()async{
  SharedPreferences spref=await SharedPreferences.getInstance();
  username.text= spref.getString('username' )??'';
   password.text=spref.getString('password')??'';
}
